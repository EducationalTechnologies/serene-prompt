...
class CategoryTitles {
  ...
  const CategoryTitles({
    this.people = 'Smileys & Menschen',
    this.nature = 'Tiere & Natur',
    this.food = 'Essen und Trinken',
    this.activity = 'Aktivitäten',
    this.travel = 'Reisen und Orte',
    this.objects = 'Objekte',
    this.symbols = 'Symbole',
    this.flags = 'Flaggen',
  });
